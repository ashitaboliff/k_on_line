...
function DateFormat(addDay) {
    let date = new Date()
    let utcDate = new Date(Date.UTC(date.getUTCFullYear(), date.getUTCMonth(), date.getUTCDate(), 15, 0, 0))
    ...
    data: [
      {
        ...
        role: 'STUDENT',
        part: [1],
        password: '$2a$05$UxevS4vImz/DMPPgVJQtQeWa.ai.LbtnE0C//hHl.Fy1D9jo0.3me',
      },
      {
        liff_id: '2',
        name: 'User 2',
  ...
  await prisma.booking.createMany({
    data: [
      ...
      },
      {
        ...
        booking_time: 2,
        regist_name: '長文バンド名サンプル長文バンド名サンプル長文バンド名サンプル長文バンド名サンプル長文バンド名サンプル長文バンド名サンプル',
